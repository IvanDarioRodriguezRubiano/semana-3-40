...
const morgan =require('morgan')//esto sirve para ver los status que se mandan
const apiRouter = require('./routes/index');
const bodyParser = require('body-parser')
const cors = require('cors');

const app = express();//mi servidor va a vivir dentro de app
app.use(cors());
...
app.use('/api',apiRouter); //manejador de las rutas de api
